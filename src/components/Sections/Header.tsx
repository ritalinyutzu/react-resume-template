...
const Header: FC = memo(() => {
  ...
  const navEntries = useMemo<NavEntry[]>(
    () => [
      ...
      {label: 'Education', href: '/#education', section: SectionId.Resume},
      ...
      {label: 'Website Portfolio', href: `/#${SectionId.Portfolio}`, section: SectionId.Portfolio},
      {label: 'Paintings', href: '/#paintings', section: SectionId.Portfolio},
