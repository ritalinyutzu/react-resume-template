...
        <br />● Developed and deployed** an intelligent exam question bank using Python (Pandas, NumPy).
        <br />● Streamlined process management by automating scheduling across the examination system.
        <br />● Led the implementation** of Intelligent Question Generation System 2.0, leveraging ML/DL to supersede inefficient manual test creation.
        <br />● Architected and built an AI Essay Grading System** utilizing*ML/DL to eliminate human grading costs, including establishing a robust ETL Pipeline.
      </p>
    ),
  },
  {
